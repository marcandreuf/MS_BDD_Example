...
public class ViewBagContentsPriorCheckoutSteps {
    ...
    public void i_have_added_a_shirt_to_my_bag() throws Throwable {
        browser.onPage(HomePage.class)
          .click_Menu("Women");
        
        browser.onPage(WomenPage.class)
          .click_LeftMenu("Shirts & Blouses");
        
        selectedItemDescription = browser.onPage(WomenSection.class)
          .filterBy("Shirt")
          .selectFirstItemWithDescKeyWord("shirt");
        
        browser.onPage(ItemPage.class)
    ...
    public void i_can_see_the_contents_of_the_bag_include_a_shirt() throws Throwable {
        browser.onPage(BagPage.class)
          .validateThereIsItemWithDescription(selectedItemDescription);
        browser.close();
    }
